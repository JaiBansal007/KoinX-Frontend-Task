...
export default function Sentiments() {
    ...
    return (
        <div className="bg-[white] w-full h-[70vh] gap-4 rounded-lg flex flex-col justify-around p-6 overflow-hidden ">
            ...
            <div className='h-auto mx-2 my-6 w-full flex flex-col gap-4'>
                ...
                <div className='flex overflow-scroll h-auto gap-4 w-full '>
                <div className='flex bg-[#e7f4fd] rounded-lg p-4 gap-4 w-2/3'>
                ...
                <div className='flex bg-[#ebf9f4] rounded-lg p-4 gap-4 w-2/3'>
